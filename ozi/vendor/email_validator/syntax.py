...
from .rfc_constants import ATEXT_HOSTNAME_INTL
from .rfc_constants import ATEXT_INTL_RE
from .rfc_constants import ATEXT_RE
from .rfc_constants import DNS_LABEL_LENGTH_LIMIT
from .rfc_constants import DOMAIN_LITERAL_CHARS
from .rfc_constants import DOMAIN_MAX_LENGTH
from .rfc_constants import DOMAIN_NAME_REGEX
from .rfc_constants import DOT_ATOM_TEXT
from .rfc_constants import DOT_ATOM_TEXT_HOSTNAME
from .rfc_constants import DOT_ATOM_TEXT_INTL
from .rfc_constants import EMAIL_MAX_LENGTH
from .rfc_constants import LOCAL_PART_MAX_LENGTH
from .rfc_constants import QTEXT_INTL
from .rfc_constants import QUOTED_LOCAL_PART_ADDR
...
def get_length_reason(addr, utf8=False, limit=EMAIL_MAX_LENGTH) -> str:
...
def validate_email_local_part(
    ...
    bad_chars = {safe_character_display(c) for c in local if not ATEXT_INTL_RE.match(c)}
    if bad_chars:
        raise EmailSyntaxError(
